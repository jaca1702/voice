...
esphome:
  name: jared-assistant
  friendly_name: Jared voice Assistant 2
  project:
...
ota:
  - platform: esphome
    password: "6337db551de4d72a73b12614b4f0ffad"
...
micro_wake_word:
  ...
  models:
    ...
    # Tu wake word personalizada Hey Jah Red
    - model: !include "archive/.esphome/micro_wake_word/bf191f7b/manifest.json"
      id: hey_jah_red
